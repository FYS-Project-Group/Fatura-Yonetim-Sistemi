...
public class ServiceProviderController {
    ...
    @PostMapping
    public ResponseEntity<ServiceProviderResponseDTO> createServiceProvider(@Valid @RequestBody ServiceProviderRequestDTO serviceProviderRequestDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ServiceProviderResponseDTO> updateServiceProvider(@PathVariable Long id, @Valid @RequestBody ServiceProviderRequestDTO serviceProviderRequestDTO) {
